...
#This script creates btop config file for use in split screen tmux session
  ...
  sed -i 's|graph_symbol_mem = "default"|graph_symbol_mem = "block" ~/.config/btop/btop.conf
  sed -i 's|graph_symbol_net = "default"|graph_symbol_net = "braille" ~/.config/btop/btop.conf
